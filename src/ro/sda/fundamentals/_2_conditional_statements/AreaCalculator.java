...
public class AreaCalculator {
    ...
    //   method overloading is when we have a method with same name but different parameters (dif number of params OR dif types OR both)
